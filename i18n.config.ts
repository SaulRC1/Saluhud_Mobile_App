import { en, en_sign_up_screen_error_messages, es, es_sign_up_screen_error_messages, en_login_screen_translations, es_login_screen_translations } from "@resources/translations/translations";
